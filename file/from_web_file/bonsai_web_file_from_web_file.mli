(** A library for creating and driving a [Bonsai_web_file.t] using the Web File API.
    ...
    In other words, most users should use [Bonsai_web_form.Elements.File_picker] instead
...
val create : ?mode:[ `Raw_contents | `As_data_url ] -> File.file Js.t -> Bonsai_web_file.t
