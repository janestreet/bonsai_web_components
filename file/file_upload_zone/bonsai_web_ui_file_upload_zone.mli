...
(** Constructs an attribute that you can place on any element in order to turn that
    element into a drop-target for uploading files.
    ...
    - [?on_drag_leave] is scheduled when the drag leaves the node or when the drop is
      completed
