...
val lift
  :  f:('parsed2 -> 'parsed1)
  -> ('input, ('result, 'parsed1) Product.t) Bonsai_arrow_deprecated.t
  -> ('input, ('result, 'parsed2) Product.t) Bonsai_arrow_deprecated.t
...
include
  ...
  with type ('result, 'input, 'parsed) t :=
    ('input, ('result, 'parsed) Product.t) Bonsai_arrow_deprecated.t
