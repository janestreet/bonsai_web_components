...
module Variant : sig
  ...
  (** This creates a form to pick a set of values of a particular variant. Each variant
      will have a separate set picker for its possible values, and the value of the form
