...
let arrow_helper = Bonsai_web_toplayer.arrow_helper

module Tooltip = struct
  module Config = struct
    type t = Bonsai_web_themed_toplayer_styling.Tooltip.t =
    ...
    let create = Bonsai_web_themed_toplayer_styling.Tooltip.create
  end
...
module Autoclose = Bonsai_web_toplayer.Autoclose
module Controls = Bonsai_web_toplayer.Controls

module Popover = struct
  module Config = struct
    type t = Bonsai_web_themed_toplayer_styling.Popover.t =
    ...
    let create = Bonsai_web_themed_toplayer_styling.Popover.create
  end
  ...
  let always_open_css ~extra_attrs ?autoclose ?focus_on_open ~content graph =
    Bonsai_web_toplayer.Popover.always_open_css
      ~attrs:extra_attrs
      ?autoclose
      ?focus_on_open
      ~content
  ...
  let create
    ...
    let autoclose, controls =
      Bonsai_web_toplayer.Private_for_bonsai_web_themed_toplayer.create_controls
        ?close_on_click_outside
        ?close_on_right_click_outside
        ?close_on_esc
        graph
...
module Modal = struct
  module Config = struct
    type t = Bonsai_web_themed_toplayer_styling.Modal.t =
