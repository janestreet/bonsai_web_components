 ...
 */
  ...
  /** @arg {CodeMirror} cm */
  function enterVimMode(cm, use_system_clipboard) {
    cm.setOption('disableInput', true);
    cm.setOption('showCursorWhenSelecting', false);
    options.use_system_clipboard = use_system_clipboard;
  ...
  */
  ...
  class RegisterController {
    ...
    pushText(registerName, operator, text, linewise, blockwise) {
      if (!registerName && options.use_system_clipboard) {
        registerName = "+";
      }
      ...
      if (!register || !registerName) {
        switch (operator) {
          case 'yank':
            ...
            if (options.use_system_clipboard) {
              this.registers['+'] = new Register(text, linewise, blockwise);
            }
            break;
          case 'delete':
          case 'change':
     ...
     */
    getRegister(name) {
      if(!name && options.use_system_clipboard) {
        name = "+";
  ...
  var actions = {
    ...
    paste: function(cm, actionArgs, vim) {
      if (!actionArgs.registerName && options.use_system_clipboard) {
  ...
  */
  ...
  var exCommands = {
    ...
    yank: function (cm, params) {
      ...
      // upstream uses '0' here, but we use null to interact correctly with our system clipboard patch
      var registerName = params.args && params.args[0] ? params.args[0] : null;
      vimGlobalState.registerController.pushText(
...
globalThis.codemirror_vim__initVim = initVim
