...
(** [component] allows a [Bonsai.graph @ local -> Vdom.Node.t Bonsai.t] to "portal" its
    ...
    The primary use-case is powering [bonsai_web_toplayer]'s popovers, modals, and
    tooltips. Portalling has also been used to drive the content of DOM nodes not
    controlled by your Bonsai app; e.g. with Codemirror-controlled tooltips.
...
module For_testing : sig
  val active_portals : Bonsai_web_portal_private.t String.Map.t Bonsai.Expert.Var.t
end
