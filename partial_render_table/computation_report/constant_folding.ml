...
let%expect_test "Constant folding cols" =
  ...
  [%expect
    ...
    │ new api, no counters: 100    │ -13 (18%)  │ -3_008 (76%) │ -7_009 (83%) │ -7_010 (83%)  │
    │ dyn cols, counters: 100      │ .          │ .            │ .            │ .             │
    │ new api, counters: 100000    │ +1 (1%)    │ -308 (4%)    │ -2_632 (23%) │ -2_631 (23%)  │
    │ new api, no counters: 100000 │ -13 (18%)  │ -3_038 (76%) │ -7_079 (83%) │ -7_080 (83%)  │
  ...
  [%expect
    ...
    ├──────────────────────────────────────────────────────────────────────────────────────────┼───────────────────┼──────────────────────┼────────────────────┤
    │ Focus by key (key not present) and unfocus in 10 element map                             │ -35 (3%)          │ -308 (49%)           │ .                  │
    ...
    │ Focus by key (key present) and unfocus in 10 element map                                 │ -35 (3%)          │ -308 (49%)           │ .                  │
    ...
    │ Focus up and down in 10 element map                                                      │ -35 (3%)          │ -308 (49%)           │ .                  │
    ...
    │ Focus left and right in a map with 10 rows                                               │ -35 (3%)          │ -308 (49%)           │ .                  │
    ...
    │ Page up and down in 10 element map                                                       │ -35 (3%)          │ -308 (49%)           │ .                  │
    ...
    │ Scroll 1-wide window from 0 to 9 and back in 100 element map                             │ -8 (2%)           │ -38 (13%)            │ .                  │
    │ Scroll 10-wide window from 0 to 9 and back in 100 element map                            │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ Scroll 1-wide window from 0 to 9 and back in 1000 element map                            │ -8 (2%)           │ -38 (13%)            │ .                  │
    │ Scroll 10-wide window from 0 to 9 and back in 1000 element map                           │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ Scroll 100-wide window from 0 to 9 and back in 1000 element map                          │ -305 (4%)         │ -3_008 (76%)         │ .                  │
    │ Apply 4 filters and clear with 100 element map using 10 window                           │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ Apply 4 filters and clear with 101 element map using 10 window                           │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ Apply 4 filters and clear with 1000 element map using 10 window                          │ -35 (3%)          │ -308 (49%)           │ .                  │
    ...
    │ Randomly select a row out of a table with 10 rows and a window of 10, then change one    │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ cell in it.                                                                              │                   │                      │                    │
    │ Randomly select a row out of a table with 100 rows and a window of 10, then change one   │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ cell in it.                                                                              │                   │                      │                    │
    │ Randomly select a row out of a table with 10000 rows and a window of 10, then change     │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ one cell in it.                                                                          │                   │                      │                    │
    │ Randomly select a row out of a table with 10 rows and a window of 10, then change all    │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ cells in it.                                                                             │                   │                      │                    │
    │ Randomly select a row out of a table with 100 rows and a window of 10, then change all   │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ cells in it.                                                                             │                   │                      │                    │
    │ Randomly select a row out of a table with 10000 rows and a window of 10, then change     │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ all cells in it.                                                                         │                   │                      │                    │
    │ Perform 10 sets of 1 items in a 10 element map with 10-wide window                       │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ Perform 10 sets of 5 items in a 10 element map with 10-wide window                       │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ Perform 10 sets of 1 items in a 11 element map with 10-wide window                       │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ Perform 10 sets of 5 items in a 11 element map with 10-wide window                       │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ Perform 10 sets of 1 items in a 100 element map with 10-wide window                      │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ Perform 10 sets of 5 items in a 100 element map with 10-wide window                      │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ Perform 10 sets of 1 items in a 1000 element map with 10-wide window                     │ -35 (3%)          │ -308 (49%)           │ .                  │
    │ Perform 10 sets of 5 items in a 1000 element map with 10-wide window                     │ -35 (3%)          │ -308 (49%)           │ .                  │
    ...
    │ Scroll 1-wide window from 0 to 9 and back in 100 element map                             │ -416 (28%)        │ -992 (97%)           │ .                  │
    │ Scroll 10-wide window from 0 to 9 and back in 100 element map                            │ -416 (23%)        │ -1_120 (85%)         │ .                  │
    │ Scroll 1-wide window from 0 to 9 and back in 1000 element map                            │ -416 (28%)        │ -992 (97%)           │ .                  │
    │ Scroll 10-wide window from 0 to 9 and back in 1000 element map                           │ -416 (23%)        │ -1_120 (85%)         │ .                  │
    │ Scroll 100-wide window from 0 to 9 and back in 1000 element map                          │ -416 (23%)        │ -1_120 (85%)         │ .                  │
    │ Apply 4 filters and clear with 100 element map using 10 window                           │ -936 (28%)        │ -2_232 (94%)         │ .                  │
    │ Apply 4 filters and clear with 101 element map using 10 window                           │ -936 (28%)        │ -2_232 (94%)         │ .                  │
    │ Apply 4 filters and clear with 1000 element map using 10 window                          │ -936 (28%)        │ -2_232 (94%)         │ .                  │
    ...
    │ Page up and down in 1000 element map                                                     │ .                 │ .                    │ .                  │
    │ Page up and down in 10000 element map                                                    │ .                 │ .                    │ .                  │
    │ Scroll 1-wide window from 0 to 9 and back in 100 element map                             │ -52 (2%)          │ -501 (28%)           │ .                  │
    │ Scroll 10-wide window from 0 to 9 and back in 100 element map                            │ -52 (2%)          │ -501 (28%)           │ .                  │
    │ Scroll 1-wide window from 0 to 9 and back in 1000 element map                            │ -52 (2%)          │ -501 (28%)           │ .                  │
    ...
    │ Apply 4 filters and clear with 100 element map using 10 window                           │ -112 (3%)         │ -1_084 (62%)         │ .                  │
    │ Apply 4 filters and clear with 101 element map using 10 window                           │ -112 (3%)         │ -1_084 (62%)         │ .                  │
    │ Apply 4 filters and clear with 1000 element map using 10 window                          │ -112 (3%)         │ -1_084 (62%)         │ .                  │
    ...
    │ Apply 4 filters and clear with 100 element map using 10 window                           │ +1_584 (182%)     │ -720 (83%)           │ .                  │
    │ Apply 4 filters and clear with 101 element map using 10 window                           │ +1_584 (182%)     │ -720 (83%)           │ .                  │
    │ Apply 4 filters and clear with 1000 element map using 10 window                          │ +1_584 (182%)     │ -720 (83%)           │ .                  │
