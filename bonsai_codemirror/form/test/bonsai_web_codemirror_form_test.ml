...
module Codemirror_test = Bonsai_web_codemirror_test
...
struct
  let name = "Bonsai_web_codemirror_form"
  ...
  let%expect_test "interacting with string form" =
    ...
    [%expect
      ...
      ==============
      <codemirror data-codemirror-editor="Bonsai_web_codemirror_form" codemirror-test-hook=<fun>>  </codemirror>
      |}];
    ...
    [%expect
      ...
      ==============
      <codemirror data-codemirror-editor="Bonsai_web_codemirror_form" codemirror-test-hook=<fun>> first line
  ...
  let%expect_test "interacting with stringable form" =
    ...
    [%expect
      ...
      ==============
      <codemirror data-codemirror-editor="Bonsai_web_codemirror_form" codemirror-test-hook=<fun>> foo this long sentence </codemirror>
      |}]
  ;;
  ...
  let%expect_test "setting into a stringable form" =
    ...
    [%expect
      ...
      ==============
      <codemirror data-codemirror-editor="Bonsai_web_codemirror_form" codemirror-test-hook=<fun>> (Foo "foo goes here") </codemirror>
      |}]
  ;;
  ...
  let%expect_test "interacting with sexpable form" =
    ...
    [%expect
      ...
      ==============
      <codemirror data-codemirror-editor="Bonsai_web_codemirror_form" codemirror-test-hook=<fun>> (Foo
      "my foo"
      ) </codemirror>
      |}]
  ;;
  ...
  let%expect_test "setting into a sexpable form" =
    ...
    [%expect
      ...
      ==============
      <codemirror data-codemirror-editor="Bonsai_web_codemirror_form" codemirror-test-hook=<fun>> (Bar 123) </codemirror>
      |}]
  ;;
end
